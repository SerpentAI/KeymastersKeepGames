...
class DJMaxRespectVGame(Game):
    ...
    def optional_game_constraint_templates(self) -> List[GameObjectiveTemplate]:
        return [
            GameObjectiveTemplate(
                label="Button Mode: MODE  Position Change: POSITION  Fader: FADER  Chaos: CHAOS",
                data={
                    "MODE": (self.button_modes, 1),
    ...
    def game_objective_templates(self) -> List[GameObjectiveTemplate]:
        return [
            GameObjectiveTemplate(
                label="Clear the following song: SONG",
                data={
                    "SONG": (self.songs, 1),
                },
            ...
            GameObjectiveTemplate(
                label="Clear the following songs: SONGS",
                data={
                    "SONGS": (self.songs, 2),
                },
                is_time_consuming=False,
